        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Complete Python application that automatically analyses news articles for any stock ticker (like AAPL or TSLA) to give you valuable sentiment scores!"
              ghLink="https://github.com/Ross-123/Stock-Market-News---Sentiment-Analyzer"
              demoLink="https://stock-market-news---sentiment-analyzer-5az4xk3umures4v7bgwzyt.streamlit.app//"
            />
          </Col>
